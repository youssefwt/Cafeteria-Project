...
function renderUsersTable(usersData) {
  for (let userData of usersData) {
    UsersTableBody.innerHTML += `<tr>
        ...
        <td class='fs-5'><a class='btn btn-warning btn-lg' href='../php/EditUser.php?id=${userData["id"]}'> Update</a></td>
        <td class='fs-5'><a class='btn btn-danger btn-lg' href='../php/DeleteUser.php?id=${userData["id"]}'> Delete</a></td></tr>`;
  }
}
